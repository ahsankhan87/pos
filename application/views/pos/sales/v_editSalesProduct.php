                                ...
                                <div class="radio-list">
                                    <label class="radio-inline" ng-init="saleType='cash'">
                                        <div class="radio" id="uniform-optionsRadios4">
                                            <input type="radio" name="saleType" ng-model="saleType" id="cash" value="cash" ng-init="saleType='cash'" checked="">
                                            Cash
                                        </div>
                                    </label>
                                    ...
                                    <label class="radio-inline">
                                        <div class="radio" id="uniform-optionsRadios5">
                                            <input type="radio" name="saleType" ng-model="saleType" ng-init="saleType='credit'" id="credit" value="credit">
                                            Credit
                                        </div>
                                    </label>
                        ...
                        <div class="col-sm-4" ng-init="register_mode='sale'">
                            <div class="form-group">
                                <div class="radio-list">
                                    <label class="radio-inline">
                                        <div class="radio" id="uniform-optionsRadios4">
                                            <input type="radio" name="register_mode" ng-model="register_mode" id="optionsRadios6" value="sale" ng-init="register_mode='sale'" checked="">
                                        </div> Sale
                                    </label>

                                    <label class="radio-inline">
                                        <div class="radio" id="uniform-optionsRadios5">
                                            <input type="radio" name="register_mode" ng-model="register_mode" id="optionsRadios7" value="return" ng-init="register_mode='return'">
                                        </div> Return
                                    </label>
