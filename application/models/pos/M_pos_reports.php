...
class M_pos_reports extends CI_Model
{
    ...
    public function product_wise_sales($from_date = null, $to_date = null, $company_id = 0, $emp_id = null, $register_mode = 'sale', $sale_type = 'cash', $categoryID = 'all')
    {
        ...
        $this->db->join('pos_sales_items AS B', 'A.sale_id = B.sale_id');
        $this->db->join('pos_items AS P', 'P.item_id = B.item_id');
        $this->db->where('A.company_id', $company_id);
