<div ng-controller="recurringInvoicesCtrl" ng-init="getAllProduct(); clearCart('<?php echo @$estimate_no; ?>');">
        ...
        <div class='col-xs-12 col-sm-9 col-md-9 col-lg-9'>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <?php //var_dump($supplier_cust); 
                    ?>
                    <label class="control-label col-sm-2" for="">Start of Period</label>
                    <div class="col-sm-4">
                        <input type="date" ng-model="period_start_date" class="form-control" />
                        
                    </div>
                    
                    <label class="control-label col-sm-2" for="">Last Send</label>
                    <div class="col-sm-4">
                        <input type="date" ng-model="last_send_date" class="form-control" />
                    </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <?php //var_dump($supplier_cust); 
                    ?>
                    <label class="control-label col-sm-2" for="">Send every</label>
                    <div class="col-sm-4">
                        <input type="number" ng-model="send_every_day" ng-init="send_every_day=1" class="form-control" />
                        <select name="send_every_month" ng-model="send_every_month" ng-init="send_every_month='month'" class="form-control" id="">
                    ...
                    <label class="control-label col-sm-2" for="">Next Shipment</label>
                    <div class="col-sm-4">
                        <input type="date" ng-model="next_shipment" class="form-control" />
                    </div>
