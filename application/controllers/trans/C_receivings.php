            ...
            if (count($posting_type_code) !== 0) {
                ...
                elseif ($data_posted->purchaseType == 'credit' && $data_posted->register_mode == 'receive') {
                    ...
                    if ($total_tax_amount > 0) {
                        ...
                        $this->M_suppliers->addsupplierPaymentEntry($tax_cr_ledger_id, $tax_dr_ledger_id, 0, $total_tax_amount, $supplier_id, $narration, $new_invoice_no, $sale_date, 1, $entry_id_tax, $emp_id);
                    } //////////////// tax

                    ////////////

                    //for customer payment table
                    $this->M_suppliers->addsupplierPaymentEntry($cr_ledger_id, $dr_ledger_id, 0, $total_amount, $supplier_id, $narration, $new_invoice_no, $sale_date, 1, $entry_id_tax, $emp_id);
                    ///
                }
                ...
                elseif ($data_posted->purchaseType == 'credit' && $data_posted->register_mode == 'return') {
                    ...
                    if ($total_tax_amount > 0) {
                        ...
                        //M_suppliers SALES TAX PAYMENT ENTRY
                        $this->M_suppliers->addsupplierPaymentEntry($tax_dr_ledger_id, $tax_cr_ledger_id, $total_tax_amount, 0, $supplier_id, $narration, $new_invoice_no, $sale_date, 1, $entry_id_tax, $emp_id);
                        // //M_suppliers SALES TAX PAYMENT ENTRY
                    ...
                    //for cusmoter payment table
                    $this->M_suppliers->addsupplierPaymentEntry($dr_ledger_id, $cr_ledger_id, $total_amount, 0, $supplier_id, $narration, $new_invoice_no, $sale_date, $entry_id, $emp_id);
                    ///
