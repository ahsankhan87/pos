                ...
                <table class="table table-striped table-condensed flip-content" id="sample_customer">
                    ...
                    <tbody>
                        ...
                        foreach ($customers as $list) {
                                ...
                                ?>
                                    <?php echo anchor('pos/C_customers/edit/' . $list['id'], '<i class="fa fa-pencil-square-o fa-fw"></i>', 'title="Edit"'); ?> |
                                    <a href="<?php echo site_url('pos/C_customers/delete/' . $list['id']) ?>" onclick="return confirm('Are you sure you want to permanent delete supplier and his account transactions?')" title="Permanent Delete"><i class="fa fa-trash-o fa-fw"></i></a>
