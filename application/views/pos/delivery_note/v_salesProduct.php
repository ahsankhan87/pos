<div ng-controller="deliveryNoteCtrl" ng-init="getAllProduct(); clearCart('<?php echo @$estimate_no; ?>');">
        ...
        <div class='col-xs-12 col-sm-9 col-md-9 col-lg-9'>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-sm-2" for=""><?php echo 'Delivery' . ' ' . lang('date'); ?></label>
                    <div class="col-sm-4">
