			...
			<div class="portlet-body">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab_1_1">
						...
						//initialize
						$sno = 1;
						(float) $dr_amount = 0.00;
						(float) $cr_amount = 0.00;
						(float) $balance = 0.00;
						...
						$dr_amount = (float) $customer[0]['op_balance_dr'];
						$cr_amount = (float) $customer[0]['op_balance_cr'];

						$balance1 = (float) ($dr_amount - $cr_amount);
						...
						if (count($customer_entries)) {
							...
							foreach ($customer_entries as $key => $list) {
								...
								$dr_amount += (float) $list['debit'];
								$cr_amount += (float) $list['credit'];
